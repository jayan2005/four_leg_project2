...
public class LoginFrame extends JFrame implements ActionListener {
	...
	public LoginFrame() {
		...
		usernameText = new JTextField(Settings.getUsername(), 25);
		secretText = new JPasswordField(Settings.getSecret(), 25);
	...
	private boolean isServerSettingsValid() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Port is not a number.", "Error", JOptionPane.ERROR_MESSAGE);
			return false;
		}
